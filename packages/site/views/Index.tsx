    ...
    <section>
      <article className="post" id="index2">
        ...
        <p>
          ...
          was built as a personal challenge to learn some technologies that I&apos;m interested in. It&apos;s built with
          React and Typescript, and the music components are powered by a GraphQL API. The infrastructure is all managed
          through AWS via CloudFormation.
        </p>
